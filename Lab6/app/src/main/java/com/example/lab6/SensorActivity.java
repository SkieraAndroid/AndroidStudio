...
public class SensorActivity extends AppCompatActivity implements SensorEventListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainContainer.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                float rectX = (screenWidth - rectWidth - imgEdgeSize)/2f;
    ...
    private void lightSensorAnimation(boolean showMoon) {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        {
            ...
            moonFadeAnimator.setDuration(2000);
            moonFadeAnimator.setInterpolator(new AccelerateDecelerateInterpolator());

            sunAnimator = ObjectAnimator.ofFloat(sunImgView,View.X,View.Y, moonPath);
            ...
            sunFadeAnimator.setDuration(2000);
            sunFadeAnimator.setInterpolator(new AccelerateDecelerateInterpolator());
        }
        else {
        ...
        final ValueAnimator colorAnimator = ValueAnimator.ofObject(new ArgbEvaluator(),startColor,endColor);
                    ...
                    public void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean b, float v, float v1) {
                        ...
                        if(v1 != 0 )
                        {
                            ...
                            reflingX.setStartVelocity(-1*v1)
                                    .setMinValue(5).setMaxValue(screenWidth-imgEdgeSize-5).setFriction(1.25f).start();
