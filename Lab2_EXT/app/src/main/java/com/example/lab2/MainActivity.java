...
//Reset the player
        ...
        sounds[1] = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.cobra11);
        sounds[2] = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.terminator);
        sounds[3] = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.entertainer);
...
//source
        backgroundPlayer = MediaPlayer.create(this, R.raw.entertainer);
